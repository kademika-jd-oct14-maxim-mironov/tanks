 ...
 * @version 3.0
 */
public class BattleFieldTemplateLast extends JPanel {
...
// End My Methods----------------------------------------------------------------------------
	...
	public static void main(String[] args) throws Exception {
		BattleFieldTemplateLast bf = new BattleFieldTemplateLast();
		bf.runTheGame();
	}

	public BattleFieldTemplateLast() throws Exception {
